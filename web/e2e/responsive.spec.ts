  ...
  test.describe(viewport.name, () => {
    ...
    test("inputs and outputs fit without clipping", async ({ page }) => {
      ...
      if (viewport.width <= 430) {
        ...
        await expect(page.locator("#spd-type").locator("option:checked")).toHaveText("Grd Spd");
        await expect(page.locator("#windRef-type").locator('option[value="Runway Angle"]')).toHaveText("RwyAngle");
      } else {
        await page.locator("#spd-type").selectOption("Ground Speed");
